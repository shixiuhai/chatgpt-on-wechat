...
class WechatChannel(Channel):
    ...
    def handle_single(self, cmsg: ChatMessage):
        ...
        process_user_message(cmsg.ctype, cmsg.content,isgroup=False, msg=cmsg)
        # print(cmsg.from_user_id,cmsg.from_user_nickname,cmsg.to_user_nickname)
        # reply = Reply(ReplyType.TEXT,"回复你的哟")
        # context = Context()
        # context.kwargs={"receiver":cmsg.from_user_id}
    ...
    def handle_group(self, cmsg: ChatMessage):
        ...
        process_user_message(cmsg.ctype, cmsg.content,isgroup=True, msg=cmsg)
